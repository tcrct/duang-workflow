...
public abstract class Assert {
    ...
    public static void hasLength( String text, String message) {
        if (!WorkflowUtils.hasLength(text)) {
            throw new IllegalArgumentException(message);
        }
    }
    ...
    public static void doesNotContain( String textToSearch, String substring, String message) {
        if (WorkflowUtils.hasLength(textToSearch) && WorkflowUtils.hasLength(substring) && textToSearch.contains(substring)) {
            throw new IllegalArgumentException(message);
        }
    }
    ...
    public static void notEmpty( Object[] array, String message) {
        if (WorkflowUtils.isEmpty(array)) {
            throw new IllegalArgumentException(message);
        }
    }
    ...
    public static void notEmpty( Collection<?> collection, String message) {
        if (WorkflowUtils.isEmpty(collection)) {
            throw new IllegalArgumentException(message);
        }
    }
    ...
    private static void instanceCheckFailed(Class<?> type,  Object obj,  String msg) {
        ...
        if (WorkflowUtils.hasLength(msg)) {
