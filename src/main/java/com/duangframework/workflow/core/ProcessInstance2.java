...
public class ProcessInstance2 {
    ...
    public ProcessInstance2(Map<String, String> conditionMap, List<String> processNode) {
    ...
    public ProcessInstance2(String id, String code, Map<String, String> conditionMap, List<String> processNode) {
        this.id = id;
        this.code = code;
        this.conditionMap = conditionMap;
        this.processNode = processNode;
